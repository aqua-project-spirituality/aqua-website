  ...
  <div class="content">
    <div class="introduction">
      ...
      <div class="vision">
        <h1>理念</h1>
        <p>
          <span style="color: gold;">aqua（アクア）</span>は、風の時代・水瓶座の時代の全盛期に向けて、スピリチュアルな旅をしている人や、本当の自分、内なる真実、そして愛を表現したい人のための<span style="text-decoration: underline;">オンライン公共スペース</span>となることを目指します。既存のSNS（ソーシャルメディア）とは異なり、将来的にビットコインのような独自の暗号通貨をプラットフォームに導入することで、スピリチュアルコミュニティの中に国家から独立した社会を構築していきます。これは多くの人にとって、突拍子もなく聞こえるかもしれませんが、今後世界において国の影響力は衰退し、そして私達のテクノロジーは既に、誰でもどんなグループでも信頼が担保された”私達の” 通貨を創ることができる地点に達しています。
        </p>
        <p>
